...
public class AuthServiceModel extends AbstractServiceModel {
    /**
     * @fields serialVersionUID
     */

    private static final long serialVersionUID = -2233409813181011718L;
    ...
    protected void handleFutureResult(Runner runner,
        ...
        if (!authMsg.isEmpty()) {
            String status = GalaxyConstants.STATUS_AUTH;
