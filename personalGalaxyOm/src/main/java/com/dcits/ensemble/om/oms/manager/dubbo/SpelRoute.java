 ...
 */
public class SpelRoute extends Route {
	
	private static final long serialVersionUID = -4737555371302188355L;
	...
	public URL toUrl() {
        ...
        return URL.valueOf(Constants.ROUTE_PROTOCOL + "://" + Constants.ANYHOST_VALUE + "/" + path
                ...
                + "&router=spel&runtime=true&enabled=" + isEnabled() + "&priority=" + getPriority() + "&force=" + isForce() + "&dynamic=false"
