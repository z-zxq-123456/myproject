...
<html>
<head>
<title>参数表IRL_ELEMENT修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/up/js/edit/irlElementMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="irlElementMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>因子名称：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="elementId" name="elementId" >
			    </div>
			    <div class="span2"> </div>
			</div>
			 <div class="row cl">
			    ...
			    <div class="row cl">
                                   ...
                                   <div class="formControls span6">
                                                   <input type="text" class="input-text grid" value="" placeholder="elementLength" id="elementLength" name="elementLength" datatype="*1-2" nullmsg=" 请输入！"  tipmsg="格式错误!">
               			    </div>
               			    <div class="span2"> </div>
               			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="elementDesc" id="elementDesc" name="elementDesc" datatype="*1-50" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="tableName" id="tableName" name="tableName" datatype="*0-20"   tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="fieldValue" id="fieldValue" name="fieldValue" datatype="*0-50"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
        <div class="row">
