...
<html>
<head>
    <title>IRL_CCY_RATE交易</title>
<script type="text/javascript" src="${ContextPath}/app/pm/up/js/IrlCcyRate.js"></script>
</head>
<body>
<div class="mb-10">
    ...
    <div class="padding-10">
        <form action="" method="post" class="form form-horizontal" id="queryPrimaryKey">
            <div class="row cl">
                        ...
                        <div class="formControls  span2">
                         <select id="RATE_TYPE" class="select2" name="rateType" tabindex="4" size="1"  style="width:100%">
                                                                </select>
        ...
        <div class="mr-20 ml-20 mt-10">
            <table id="irlCcyRate" class="table table-border table-bordered table-hover table-bg table-sort">
                <thead>
                     <tr class="text-c">
                        <th>操作类型</th>
