...
<html>
<head>
    <title>交易IRL_INT_TYPE添加</title>
    <script type="text/javascript" src="${ContextPath}/app/pm/up/js/add/irlIntTypeAdd.js"></script>
...
<body>
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="irlIntTypeAdd">
        <div class="row cl">
            <label class="form-label span4"><span class="c-red">*</span>利率税率类型：</label>
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="intTaxType" id="intTaxType"
                       name="IRL_INT_TYPE" datatype="*1-3" nullmsg=" 请输入！" tipmsg="格式错误!"
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="intTaxTypeDesc" id="intTaxTypeDesc"
                       name="IRL_INT_TYPE" datatype="*1-30" nullmsg=" 请输入！" tipmsg="格式错误!">
            </div>
            <div class="span2"></div>
        </div>
        <div class="row cl">
