...
<html>
<head>
<title>参数表GL_SYSTEM修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/glr/js/edit/glSystemMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="glSystemMod">
			<div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="acctHistPeriodNo" id="acctHistPeriodNo" name="acctHistPeriodNo" datatype="*1-3" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="runDate" id="runDate" name="runDate" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="revalByPost" id="revalByPost" name="revalByPost" datatype="*1-1" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="profitCentre" id="profitCentre" name="profitCentre" datatype="*1-12" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="nextRunDate" id="nextRunDate" name="nextRunDate" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="mutiSettleMode" id="mutiSettleMode" name="mutiSettleMode" datatype="*1-2" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="maxFuturedateDay" id="maxFuturedateDay" name="maxFuturedateDay" datatype="*1-3" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="maxBackdateDay" id="maxBackdateDay" name="maxBackdateDay" datatype="*1-3" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="lastRunDate" id="lastRunDate" name="lastRunDate" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="histPeriodType" id="histPeriodType" name="histPeriodType" datatype="*1-1" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="histPeriodNo" id="histPeriodNo" name="histPeriodNo" datatype="*1-3" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="taxFreq" name="taxFreq" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="suspAssetAcct" name="suspAssetAcct" class="select2" tipmsg="格式错误!"  nullmsg=" 请输入！" datatype="*">
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="suspContAsset" name="suspContAsset" class="select2" tipmsg="格式错误!"  nullmsg=" 请输入！" datatype="*">
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="suspContLiab" name="suspContLiab" class="select2" tipmsg="格式错误!" nullmsg=" 请输入！" datatype="*" >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="osCloseBal" name="osCloseBal" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="suspSettleLiab" name="suspSettleLiab" class="select2" tipmsg="格式错误!"  nullmsg=" 请输入！" datatype="*">
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="retainEarnings" name="retainEarnings" class="select2" tipmsg="格式错误!"  nullmsg=" 请输入！" datatype="*">
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="intPayable" name="intPayable" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="interAcctgBk" name="interAcctgBk" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="suspSettleAsset" name="suspSettleAsset" class="select2" tipmsg="格式错误!" nullmsg=" 请输入！" datatype="*" >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="glCashCode" name="glCashCode" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="defaultRateType" name="defaultRateType" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="defaultBranch" name="defaultBranch" class="select2" tipmsg="格式错误!"  nullmsg=" 请输入！" datatype="*">
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="suspLiabAcct" name="suspLiabAcct" class="select2" tipmsg="格式错误!"  nullmsg=" 请输入！" datatype="*">
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
