...
<html>
<head>
<title>交易AC_SUBJECT添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/glr/js/add/acSubjectAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="acSubjectAdd">
					<div class="row cl">
						<label class="form-label span4"><span class="c-red">*</span>科目代码：</label>
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="subjectCode" id="subjectCode" name="AC_SUBJECT" datatype="*1-20" nullmsg=" 请输入！"  tipmsg="格式错误!"  ajaxurl="${ContextPath}/baseCommon/verifyOneKeyValueRepeat">
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="subjectDesc" id="subjectDesc" name="AC_SUBJECT" datatype="*1-100" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="glType" id="glType" name="AC_SUBJECT" datatype="*1-1" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
