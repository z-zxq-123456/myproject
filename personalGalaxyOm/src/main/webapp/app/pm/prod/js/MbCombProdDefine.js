var tableNames="MB_PROD_TYPE,MB_EVENT_ATTR,MB_PROD_DEFINE,MB_EVENT_PART,MB_PROD_GROUP,MB_PROD_RELATION_DEFINE,MB_EVENT_LINK,MB_EVENT_TYPE";
var transActionId="MB_COMB_PROD_DEFINE";
$(function(){
 		        $("#newProdDiv").hide();
                $("#comb").hide();
                $("#master").hide();
                ...
                $.ajax({
                           ...
                           data:{
                                 ...
                                 tableName:"PROD_MB_COMB_PROD_DEFINE",
                ...
                $("#three").click(function() {
 				...
 				$("#attrList").click(function(){
                    ...
                    var indexForEdit = layer.open({
                         type: 2,
                         content: contextPath + "/app/pm/prod/jsp/CardProdAttrList.jsp",
                         end: function(){
                                                  ...
                                                  showMsg(json.retMsg, 'info');
                                                           ...
                                                           var url = contextPath + "/prodDefine/save";
                                                            ...
                                                            $("#compontentP").children().each(function() {
                                                                ...
                                                                $("#divCombProdList").children().each(function() {
                                                                        var abc = {};
                                                                        var index6 = 0;
                                                                        var index5 = 0;
                                                                        var index4 = 0;
                                                                ...
                                                                $("#combProdList tbody").find("tr").each(function(j) {
                                                                 ...
                                                                 $("#childProdList tbody").find("tr").each(function(k) {
                                                                  ...
                                                                  $("#prodTableM tbody").find("tr").each(function() {
                                                                         var result3 = {};
                                                                     $(this).find("td").each(function(k){
                                                                              if(k === 0){
                   ...
                   showMsg(json.errorMsg, 'errorMsg');
                    ...
                    $(document).ready(function() {
                     ...
                     $("#listAdd").click(function() {
                              ...
                              var indexA = 0;
                              var count = 0;
                         $("#childProdList tbody").find("tr").each(function() {
                                 $(this).find("td").each(function(k){
                                        if(k === 0){
