...
<html>
<head>
<title>参数表MB_EVENT_CLASS修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/prod/js/edit/mbEventClassMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="mbEventClassMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>事件分类：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="eventClass" name="eventClass" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="eventClassDesc" id="eventClassDesc" name="eventClassDesc" datatype="*1-100" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
