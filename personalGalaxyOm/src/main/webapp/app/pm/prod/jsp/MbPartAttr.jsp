    ...
    <%@ include file="/form.jsp" %>
        <html>
            <head>
                ...
                type="text/css" />
                <script type="text/javascript" src="${ContextPath}/app/pm/prod/js/MbPartAttr.js"></script>
            ...
            <body>
                ...
                <div class="row mt-20" style="margin-left:3%;">
                    ...
                    <a id="save" class="button-edit  S" style="margin:0px 1%;">
                        <i class="iconfont icon-writefill">
                        </i>
                        保存
                    </a>
                    <a id="attrList" class="button-edit  S" style="margin:0px 1%;">
                        <i class="iconfont icon-writefill">
                        </i>
                        查看数据
                    </a>
                  <a id="nullifyAppNo" class="button-edit  S" style="margin:0px 1%;">
                                        <i class="iconfont icon-writefill">
                                        </i>
                                       操作作废
                                    </a>
