...
<html>
<head>
<script type="text/javascript" src="${ContextPath}/app/pm/prod/js/add/irlProdIntTAdd.js"></script>
    <title>参数表IRL_PROD_INT添加</title>
</head>
<body>
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="irlProdIntAdd">
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="prodType" id="prodType"
                       name="prodType" datatype="*1-20" nullmsg=" 请输入！" tipmsg="格式错误!">
            </div>
            <div class="span2"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="eventType" id="eventType"
                       name="eventType" datatype="*1-20" nullmsg=" 请输入！" tipmsg="格式错误!">
            </div>
            <div class="span2"></div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="intClass" id="intClass"
                       name="intClass" datatype="*1-20" nullmsg=" 请输入！" tipmsg="格式错误!">
            </div>
            <div class="span2"></div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <select id="taxType" name="taxType" class="select2" tabindex="4" tipmsg="格式错误!">
                    <option value="" selected="selected">空</option>
                </select>
            </div>
            <div class="span2"></div>
        ...
        <div class="row cl">
            ...
            <div class="row cl">
                    ...
                    <div class="formControls span6">
                        <input type="text" class="input-text grid" value="" placeholder="groupRuleType"
                               id="groupRuleType" name="groupRuleType" nullmsg=" 请输入！"  datatype="*1-3"   tipmsg="格式错误!">
                    </div>
                    <div class="span2"></div>
                </div>
        <div class="row cl">
