    ...
    <%@ include file="/form.jsp" %>
        <html>
            <head>
                    ...
                    <script type="text/javascript" src="${ContextPath}/app/pm/prod/js/MbCombProdDefine.js"></script>
            ...
            <div class="mr-10 ml-10">
              <nav class="breadcrumb" style="height:40px;"><i class="iconfont">&#xe61d;</i>系统首页<span class="c-gray en">&gt;</span>产品工厂<span class="c-gray en">&gt;</span>组合产品定义<a class="btn radius r mr-20 size-MINI" href="javascript:location.replace(location.href);" title="刷新"><i class="iconfont">&#xe61e;</i></a></nav>
            </div>
                		...
                		<div class="row" style="margin-top:60px;">
                		   ...
                		   <select id="operateType" name="operateType" class="select2">
                            ...
                            <label class="form-label mt-5"> 产品：</label>
                             <input type="text" class="input-text" value="" placeholder="产品类型" id="prodType" name="prodType" style="width:11%;" >
                		...
                		<div class="step-list" style="margin-top:30px;">
                            <div class="text-c"><!--4-->
                                 ...
                                 <div class="row mt-20">
                                    ...
                                    <div class="formControls span2 ml-5">
                                        <select id="prodC" name="prodC" data-placeholder="子产品类型"  datatype="*1-40" nullmsg="子产品类型"  class="select2" style="width:100%;">
                                           <option value="" selected="selected">请选择</option>
                                        </select>
                                    </div>
