...
<html>
<head>
<title>参数表MB_ATTR_CLASS修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/prod/js/edit/mbAttrClassMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="mbAttrClassMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>属性分类：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="attrClass" name="attrClass" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="attrClassDesc" id="attrClassDesc" name="attrClassDesc" datatype="*1-100" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
					<div class="row cl">
