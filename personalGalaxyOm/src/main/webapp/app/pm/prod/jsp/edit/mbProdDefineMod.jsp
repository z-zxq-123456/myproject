...
<html>
<head>
<title>参数表MB_PROD_DEFINE修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/prod/js/edit/mbProdDefineMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="mbProdDefineMod">
			<div class="row cl">
