...
<html>
<head>
<title>参数表MB_ATTR_TYPE修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/prod/js/edit/mbAttrTypeMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="mbAttrTypeMod">
			<div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="attrDesc" id="attrDesc" name="attrDesc" datatype="*1-100" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
        			<select id="busiCategory" name="busiCategory" data-placeholder="业务分类" class="select2"  multiple="multiple" nullmsg="业务分类不能为空" >
                    </select>
                 </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                        <select id="useMethod" name="useMethod"  class="select2" tipmsg="格式错误!" datatype="*"  nullmsg="业务分类不能为空" >
                            <option value="" selected="selected">空</option>
