...
<html>
<head>
<title>参数表CIF_RELATION_TYPE修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/cifRelationTypeMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="cifRelationTypeMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>类型：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="relationType" name="relationType" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="relationDesc" id="relationDesc" name="relationDesc" datatype="*1-100" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="counterRel" name="counterRel" datatype="*"  class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
