...
<html>
<head>
<title>参数表FM_PROFIT_CENTRE修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/fmProfitCentreMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="fmProfitCentreMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>利润中心：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="profitCentre" name="profitCentre" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="profitCentreDesc" id="profitCentreDesc" name="profitCentreDesc" datatype="*1-100" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
