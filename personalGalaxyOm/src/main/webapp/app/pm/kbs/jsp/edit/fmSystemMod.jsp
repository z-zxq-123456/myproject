...
<html>
<head>
<title>参数表FM_SYSTEM修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/fmSystemMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="fmSystemMod">
			<div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="interBranchInd" id="interBranchInd" name="interBranchInd" datatype="*1-1" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="yrEndDate" id="yrEndDate" name="yrEndDate" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="mthEndDate" id="mthEndDate" name="mthEndDate" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="halfEndDate" id="halfEndDate" name="halfEndDate" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="qurEndDate" id="qurEndDate" name="qurEndDate" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="limitCcy" name="limitCcy" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="reportCcy" name="reportCcy" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="defaultBranch" name="defaultBranch" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="defaultRateTypeLocal" name="defaultRateTypeLocal" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
