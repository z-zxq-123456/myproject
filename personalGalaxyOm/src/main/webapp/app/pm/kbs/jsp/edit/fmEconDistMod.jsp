...
<html>
<head>
<title>参数表FM_ECON_DIST修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/fmEconDistMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="fmEconDistMod">
			<div class="row cl">
