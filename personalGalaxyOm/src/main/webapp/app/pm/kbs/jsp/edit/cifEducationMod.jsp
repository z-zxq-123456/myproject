...
<html>
<head>
<title>参数表CIF_EDUCATION修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/cifEducationMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="cifEducationMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>教育程度编号：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="education" name="education" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
