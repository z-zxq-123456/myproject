...
<html>
<head>
<title>参数表CIF_QUALIFICATION修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/cifQualificationMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="cifQualificationMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>职称：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="qualification" name="qualification" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
