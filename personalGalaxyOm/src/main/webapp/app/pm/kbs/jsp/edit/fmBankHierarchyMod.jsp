...
<html>
<head>
<title>参数表FM_BANK_HIERARCHY修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/fmBankHierarchyMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="fmBankHierarchyMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>层级代码：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="hierarchyCode" name="hierarchyCode" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
