...
<html>
<head>
<title>参数表MB_STAGE_INT修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/mbStageIntMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="mbStageIntMod">
			<div class="row cl">
			...
			<div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                <select id="eventType" name="eventType" class="select2" tipmsg="格式错误!"  >
                                </select>
			    </div>
			    <div class="span2"> </div>
			    </div>
