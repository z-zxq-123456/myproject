...
<html>
<head>
<title>参数表RC_LIST_CHECK_RULE修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/rcListCheckRuleMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="rcListCheckRuleMod">
			<div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="forbidChannels" id="forbidChannels" name="forbidChannels" datatype="*1-200" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="forbidEvents" id="forbidEvents" name="forbidEvents" datatype="*1-200" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
