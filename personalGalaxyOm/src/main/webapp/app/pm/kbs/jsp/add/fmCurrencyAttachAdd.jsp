...
<html>
<head>
<title>交易FM_CURRENCY_ATTACH添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/add/fmCurrencyAttachAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="fmCurrencyAttachAdd">
					<div class="row cl">
