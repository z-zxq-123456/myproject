...
<html>
<head>
    <title>FM_LOC_HOLIDAY交易</title>
    <script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/FmLocHoliday.js"></script>
</head>
<body>
<div class="mb-10">
    ...
    <div class="padding-10">
        ...
        <div class="mr-20 ml-20 mt-10">
            <table id="fmLocHoliday" class="table table-border table-bordered table-hover table-bg table-sort">
                <thead>
                     <tr class="text-c">
                        <th>操作类型</th>
                        <th>节假日日期</th>
