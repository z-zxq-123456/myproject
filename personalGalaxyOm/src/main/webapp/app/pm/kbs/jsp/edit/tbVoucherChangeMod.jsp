...
<html>
<head>
<title>参数表TB_VOUCHER_CHANGE修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/TbVoucherChangeMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="tbVoucherChangeMod">
                <div class="row cl">
                    <label class="form-label span4"><span class="c-red">*</span>描述信息：</label>
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="statusDesc" id="statusDesc" name="statusDesc" datatype="*1-50" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
