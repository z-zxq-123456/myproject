...
<html>
<head>
<title>参数表FM_SEQ_TYPE_DTL修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/fmSeqTypeDtlMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="fmSeqTypeDtlMod">
			<div class="row cl">
			...
			<div class="row cl">
			    ...
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="seqResetParam" name="seqResetParam" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
