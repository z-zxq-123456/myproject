...
<html>
<head>
<title>参数表MB_OPEN_CTL修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/mbOpenCtlMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="mbOpenCtlMod">
			<div class="row cl">
			...
			<div class="row cl">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="" placeholder="quantity" id="quantity" name="quantity" datatype="n1-10,/^[1-9]\d*$/" nullmsg=" 请输入！"  tipmsg="格式错误!">
			    </div>
			    <div class="span2"> </div>
			    </div>
                <div class="row cl">
