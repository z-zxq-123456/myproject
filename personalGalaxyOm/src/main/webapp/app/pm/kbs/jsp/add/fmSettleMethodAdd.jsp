...
<html>
<head>
<title>交易FM_SETTLE_METHOD添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/add/fmSettleMethodAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="fmSettleMethodAdd">
					<div class="row cl">
						<label class="form-label span4"><span class="c-red">*</span>结算方法：</label>
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="settleMethod" id="settleMethod" name="FM_SETTLE_METHOD" datatype="*1-3" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
						...
						<div class="formControls span6">
								<select id="payRec" name="payRec" data-placeholder="收付标记" class="select2"  tabindex="4" datatype="*" nullmsg=" 请输入！" tipmsg="格式错误!">
										<option value="P" >P-付</option>
										<option value="R" >R-收</option>
								</select>
						</div>
						<div class="span2"> </div>
					</div>
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="settleMethodDesc" id="settleMethodDesc" name="FM_SETTLE_METHOD" datatype="*1-20" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="releaseSecurity" id="releaseSecurity" name="FM_SETTLE_METHOD" datatype="*1-1" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="format" id="format" name="FM_SETTLE_METHOD" datatype="*1-8" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
