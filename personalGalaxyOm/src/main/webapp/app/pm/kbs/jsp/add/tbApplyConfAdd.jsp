...
<html>
<head>
<title>交易TB_APPLY_CONF添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/add/tbApplyConfAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="tbApplyConfAdd">
					<div class="row cl">
