...
<html>
<head>
<title>参数表FM_USER修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/edit/fmUserMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="fmUserMod">
			<div class="row cl">
			    <label class="form-label span4"><span class="c-red">*</span>柜员ID：</label>
			    <div class="formControls span6">
			        <input type="text" class="input-text grid" value=""  id="userId" name="userId" >
			    </div>
			    <div class="span2"> </div>
			</div>
                <div class="row cl">
