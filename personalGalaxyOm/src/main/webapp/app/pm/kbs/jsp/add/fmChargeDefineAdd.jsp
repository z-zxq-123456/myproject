...
<html>
<head>
<title>交易FM_CHARGE_DEFINE添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/kbs/js/add/fmChargeDefineAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="fmChargeDefineAdd">
					<div class="row cl">
						<label class="form-label span4"><span class="c-red">*</span>服务费类型：</label>
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="chargeType" id="chargeType" name="FM_CHARGE_DEFINE" datatype="*1-10" nullmsg=" 请输入！"  tipmsg="格式错误!"  ajaxurl="${ContextPath}/baseCommon/verifyOneKeyValueRepeat">
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
