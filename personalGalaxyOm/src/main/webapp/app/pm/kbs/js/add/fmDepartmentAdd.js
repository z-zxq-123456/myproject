...
function fmDepartmentAdd(){
	...
	sendPostRequest(url,params, callback_fmDepartmentAdd,"json");
}

function callback_fmDepartmentAdd(json){
	if (json.success) {
...
function fmDepartmentAddCancel(){
