...
function fmLocHolidayAdd(){
	...
	sendPostRequest(url,params, callback_fmLocHolidayAdd,"json");
}

function callback_fmLocHolidayAdd(json){
	if (json.success) {
...
function fmLocHolidayAddCancel(){
