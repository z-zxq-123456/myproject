...
<head>
<title>角色修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/js/paraSetting/edit/userStepEdit.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-edit">
        <div class="row">
            ...
            <div class="formControls span6">
                <select class="select2" size="1" id="userId" name="userId" datatype="*" disabled>
				</select>
            </div>
			<div class="span2"> </div>
        </div>
