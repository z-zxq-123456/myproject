...
<head>
<title>用户修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/js/paraSetting/edit/paraNamespaceEdit.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-namespace-edit">
	    <div class="row">
        				<label class="form-label span4"><span class="c-red">*</span>交易名：</label>
        				<div class="formControls span6">
        					<input type="text" class="input-text grid" placeholder="请输入1-50位字符！" value="" id="transactionId" name="transactionId" datatype="*1-50" nullmsg="请输入" tipmsg="格式错误!" disabled>
        				</div>
        				<div class="span2"> </div>
        			</div>
        <div class="row">
		...
		<div class="row">
				...
				<div class="formControls span6">
				<select class="select2" size="1" id="systemId" name="systemId" datatype="*" placeholder="不能为空！" nullmsg="请选择！" tipmsg="格式错误!" disabled>
                 </select>
				</div>
				<div class="span2"></div>
			</div>
			...
			<div class="row">
				...
				<div class="formControls span6">
					<input type="text" class="input-text grid" placeholder="请输入0-100位字符！" datatype="*0-100" value="" id="jspUrl" name="jspUrl" >
				</div>
				<div class="span2"> </div>
			</div>
			<div class="row">
			<label class="form-label span4"><span class="c-red">*</span>录入复核是否同一人：</label>
			<div class="formControls span6">
        ...
        <div class="row">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" placeholder="请输入1-60位字符！" value="" datatype="*1-60" id="namespaceName" name="namespaceName" >
            </div>
            <div class="span2"> </div>
        </div>
