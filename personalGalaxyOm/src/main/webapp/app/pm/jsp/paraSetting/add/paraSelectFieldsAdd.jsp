...
<head>
<title>用户修改</title>
<script type="text/javascript" src="${ContextPath}/app/pm/js/paraSetting/add/paraSelectFieldsAdd.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-select-edit">
		<div class="row">
            			...
            			<div class="formControls span6">
            				<select class="select2" size="1" id="tableName" name="tableName" datatype="*1-32" placeholder="不能为空！" nullmsg="请选择！" tipmsg="格式错误!" ajaxurl="${ContextPath}/paraSelectFields/vaildSelect">
            				</select>
            			</div>
                        <div class="span2"> </div>
            		</div>
