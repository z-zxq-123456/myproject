...
<head>
<title>用户添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/js/paraSetting/add/paraTableFieldsAdd.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-table-add">
	<div class="row">
    			<label class="form-label span4"><span class="c-red">*</span>交易名：</label>
    			<div class="formControls span6">
    				<select class="select2" size="1" id="tableName" name="tableName" datatype="*1-50" placeholder="不能为空！" nullmsg="请选择！" tipmsg="格式错误!">
    				</select>
    			</div>
                <div class="span2"> </div>
    		</div>
		<div class="row">
        			...
        			<div class="formControls span6">
        				<select class="select2" size="1" id="columnName" name="columnName" datatype="*1-32" placeholder="不能为空！" nullmsg="请选择！" tipmsg="格式错误!">
                        </select>
        			</div>
        			<div class="span2"></div>
        </div>
