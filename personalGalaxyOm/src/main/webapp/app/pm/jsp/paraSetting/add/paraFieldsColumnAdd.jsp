...
<head>
<title>列字段添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/js/paraSetting/add/paraFieldsColumnAdd.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-column-add">
	        <div class="row">
                 ...
                 <div class="formControls span6">
                 	<input type="text" class="input-text grid" id="columnName" placeholder="请输入1-32位字符"  name="columnName" datatype="*1-32" nullmsg="请输入！" tipmsg="格式错误!" ajaxurl="${ContextPath}/paraFieldsColumn/vaildColumn">
                 </div>
                 <div class="span2"> </div>
            </div>
    		<div class="row">
    		...
    		<div class="row" id="RF2">
                 ...
                 <div class="formControls span6">
                 	<input type="text" class="input-text grid" id="refCol" placeholder="请输入0-10位字符"  name="refCol" datatype="*0-100" nullmsg="请输入！" tipmsg="格式错误!">
                 </div>
                 <div class="span2"> </div>
            </div>
