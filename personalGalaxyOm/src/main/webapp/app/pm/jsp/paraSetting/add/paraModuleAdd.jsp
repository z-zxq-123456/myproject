...
<head>
<title>用户添加</title>
<script type="text/javascript" src="${ContextPath}/app/pm/js/paraSetting/add/paraModuleAdd.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-module-add">
		<div class="row">
			<label class="form-label span4"><span class="c-red">*</span>模块代码：</label>
			<div class="formControls span6">
				<input type="text" class="input-text grid" id="moduleId" placeholder="请输入1-10位字符"  name="moduleId" datatype="*1-10" nullmsg="请输入！" tipmsg="格式错误!">
			</div>
			<div class="span2"></div>
		</div>
		<div class="row">
