...
$(document).ready(function() {
    ...
    $("#selectByPrimaryKey").click(function(){
...
)
        {
            ...
            var attrTab = $("#cmcCardOrderNoInfo").dataTable();
            var api = attrTab.api();
...
function  cmcCardOrderNoInfoDel(){
        ...
        sendPostRequest(url,params, callback_cmcCardOrderNoInfoDel,"json");
}
...
/*查看差异数据*/
function  cmc_card_order_no_info_contrast(){
    var attrTab = $("#cmcCardOrderNoInfo").dataTable();
    var api = attrTab.api();
    api.ajax.url(contextPath+"/baseCommon/contrastBase?tableName=CMC_CARD_ORDER_NO_INFO").load();
...
function cmc_card_order_no_info_submit(){
    layer.confirm('确认要提交吗？',function(){
        var url = contextPath+"/baseCommon/submitParaData";
        sendPostRequest(url,{
            "tableName":"CMC_CARD_ORDER_NO_INFO",
            "reqNum": parent.$(".breadcrumb").data("reqNum")
            }, callback_cmcCardOrderNoInfoSubmit,"json");
    });
}

function  callback_cmcCardOrderNoInfoSubmit(json){
    if (json.success) {
...
function selectAll_refresh(){
  	var prodTab = $("#cmcCardOrderNoInfo").dataTable();
    var api = prodTab.api();
    api.ajax.reload();
}
...
function initData_refresh(){
  	var prodTab = $("#cmcCardOrderNoInfo").dataTable();
    var api = prodTab.api();
    api.ajax.url(contextPath+"/baseCommon/getList?tableName=CMC_CARD_ORDER_NO_INFO").load();
}