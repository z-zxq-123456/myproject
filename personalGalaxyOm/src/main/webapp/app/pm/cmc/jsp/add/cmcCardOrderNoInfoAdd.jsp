...
<script type="text/javascript" src="${ContextPath}/app/pm/cmc/js/add/cmcCardOrderNoInfoAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="cmcCardOrderNoInfoAdd">
					...
					<div class="formControls span6">
					    <select id="productRuleNo" name="CMC_CARD_ORDER_NO_INFO" data-placeholder="productRuleNo" class="select2"  tabindex="4" datatype="*" nullmsg=" 请输入！" tipmsg="格式错误!"  ajaxurl="${ContextPath}/baseCommon/verifyOneKeyValueRepeat">
					    </select>
				     </div>
						<%-- <div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="productRuleNo" id="productRuleNo" name="CMC_CARD_ORDER_NO_INFO" datatype="*1-4" nullmsg=" 请输入！"  tipmsg="格式错误!"  ajaxurl="${ContextPath}/baseCommon/verifyOneKeyValueRepeat">
						</div> --%>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
