...
<script type="text/javascript" src="${ContextPath}/app/pm/cmc/js/edit/cmcCardNoRoleInfoMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="cmcCardNoRoleInfoMod">
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="1" placeholder="fldnum1" id="fldnum1" name="fldnum1" datatype="*1-10" nullmsg=" 请输入！"  tipmsg="格式错误!" disabled="disabled">
            </div>
            <div class="span2"> </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl"> 
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="2" placeholder="fldnum2" datatype="*1-10" id="fldnum2" name="fldnum2"  nullmsg=" 请输入！" tipmsg="格式错误!" disabled="disabled">
            </div>
            <div class="span2"> </div>
        </div>
      <!--   <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="span2"> </div>
                ...
                <div class="row cl">
                    ...
                    <div class="formControls span6">
                                    <input type="text" class="input-text grid" value="1" placeholder="vryBitLen" id="vryBitLen" name="vryBitLen" datatype="*1-10" nullmsg=" 请输入！"  tipmsg="格式错误!" disabled="disabled">
			    </div>
			    <div class="span2"> </div>
			    </div>
