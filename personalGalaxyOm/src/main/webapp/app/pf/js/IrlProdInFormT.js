var selectIs = 0;
    $(document).ready(function () {
        ...
        if(parent.$("#operateType").val() == "add"){
              ...
              opt.ajax= {
                      "url": contextPath+"/irlProdInt/getAllByNewProdType?prodType=" + parent.$("#prodType").val() + "&newProdType=" + parent.$("#newProdType").val(),
                      "type": "POST"
                  };
            }
        opt.columns = [
           ...
           {"data": "intApplType", "defaultContent": ""},
            ...
            {"data": "monthlyBasis", "defaultContent": ""},
    ...
    if(parent.$("#operateType").val() == "update"){
        ...
        $("#add").on("click", function () {
            irl_prod_int_add('添加', 'irlProdIntTAdd.jsp', '600', '520');
        });
        $("#edit").on("click", function () {
            irl_prod_int_mod('修改', 'irlProdIntTEdit.jsp', '600', '520');
        });
        ...
        $("#add").on("click", function () {
            irl_prod_int_addN('添加', 'irlProdIntTAdd.jsp', '600', '520');
        });
        $("#edit").on("click", function () {
            irl_prod_int_modN('修改', 'irlProdIntTEdit.jsp', '600', '520');
        });
        $("#delete").on("click", function () {
            irl_prod_int_delN();
        });
    ...
    function showMsgDuringTime(msg)
    {
      ...
      function irlProdIntDel(){
          	var url = contextPath+"/irlProdInt/delete1";
