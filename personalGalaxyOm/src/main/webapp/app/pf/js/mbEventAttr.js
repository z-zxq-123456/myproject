                            ...
                            function(partRet) {
                                ...
                                for (var i = 0; i < partRet.length; i++) {
                                    if (partRet[i].assembleType == "ATTR") {
                                        ...
                                        div = showPartDiv1(partRet[i].assembleId,  partRet[i].partDesc,partRet[i].data,"O");
                        ...
                        $("#save").click(function() {
                             if($("#eventClass").val() == "" || $("#processMethod").val() == ""){
                                  ...
                                  if($("#newEventType").val() == "" || $("#newEventDesc").val() == ""){
                                     ...
                                     var url = contextPath + "/eventType/insert1";
                                      $.ajax({
                                          url: url,
                                          async:false,
                                          data:{
                                          ...
                                          success: function(json) {
                                               if (json.retStatus == 'F') {
                                                showMsg(json.retMsg, 'info');
                                                    ...
                                                    var url = contextPath + "/eventAttr/save1";
                                                    var data = [];
                                                    var index = 0;
                                                ...
                                                $("#compontentP").children().each(function(i) {
                                                    ...
                                                    $(this).find(".attrs").each(function(k) {
                                                     var partAttr = {};
                               ...
                               var url = contextPath + "/eventType/update1";
                               $.ajax({
                                   url: url,
                                   async:false,
                                   data:{
                                                ...
                                                success: function(json) {
                                                     if (json.retStatus == 'F') {
                                                      showMsg(json.retMsg, 'info');
                                                        ...
                                                        var url = contextPath + "/eventAttr/copy1";
                                                        var data = [];
                                                        var index = 0;
                                                           $("#tabDiv").find(".attr").each(function(i) {
                                                             var abc = {};
        ...
        $("#prodType").focus(function(){
           if($("#Bmodule").val() ==""){
            ...
            layer.open({
                type: 2,
                title:"请选择产品",
                content: contextPath+"/app/pf/jsp/prodTreeTable2.jsp",
                area: [500+'px', 400+'px'],
                end: function(){
                    //$("#eventType").val("");
                   // $("#eventDesc").val("");
