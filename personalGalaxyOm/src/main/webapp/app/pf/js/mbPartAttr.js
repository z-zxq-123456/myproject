               ...
               $("#save").click(function() {
                     if($("#processMethod").val() == "" || $("#busiCategory").val() == ""){
                         ...
                         return;
                             ...
                             var url = contextPath + "/partType/update1";
                             $.ajax({
                                 url: url,
                                 data:{
                         ...
                         if($("#newPartType").val() == "" || $("#newPartDesc").val() == ""){
                             ...
                             return;
                               ...
                               var url = contextPath + "/partType/insert1";
                               $.ajax({
                                   url: url,
                                   async:false,
                                   data:{
                                  ...
                                  success: function(json) {
                                       if (json.retStatus == 'F') {
                                        showMsg(json.retMsg, 'info');
                                          ...
                                          var url = contextPath + "/partCon/copy1";
                                          var data = [];
                                         $("#compontent").children().each(function(i) {
                                              var abc = {};
                                              abc["partType"] = $("#newPartType").val();
