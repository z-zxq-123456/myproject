...
<html>
<head>
<script type="text/javascript" src="${ContextPath}/app/pf/js/glProdAccountingAddPf.js"></script>
<title>参数表GL_PROD_ACCOUNTING添加</title>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="glProdAccountingAdd">
		...
		<div class="row cl">
			...
			<div class="formControls span6">
								<select id="glCodeALoss" name="glCodeALoss" datatype="*" class="select2" tabindex="4" tipmsg="格式错误!">
								</select>
			</div>
			<div class="span2"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls span6">
								<select id="glCodeAdjust" name="glCodeAdjust" datatype="*" class="select2" tabindex="4" tipmsg="格式错误!">
								</select>
			</div>
			<div class="span2"> </div>
		</div>
