...
<html>
<head>
<script type="text/javascript" src="${ContextPath}/app/pf/js/irlProdIntTAdd.js"></script>
...
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="irlProdIntAdd">
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="monthlyBasis" datatype="*0-3"
                       id="monthlyBasis" name="monthlyBasis" tipmsg="格式错误!">
            </div>
            <div class="span2"></div>
        </div>
