...
<head>
<title>属性添加</title>
<script type="text/javascript" src="${ContextPath}/app/pf/js/mbAttrAdd.js"></script>
</head>
<body>
	...
	<form action="" method="post" class="form form-horizontal" id="form-attr-add">
		<div class="row cl">
			...
			<div class="formControls span6">
				<input type="text" class="input-text grid" value="" placeholder="attrClass" id="attrClass" name="attrClass" datatype="/^[A-Z\(_)]+$/" nullmsg="属性分类不能为空">
			</div>
			<div class="span2"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls span6">
				<input type="text" placeholder="attrClassDesc"  value="" id="attrClassDesc" name="attrClassDesc" class="input-text grid" datatype="*1-40" nullmsg="属性分类描述不能为空">
			</div>
			<div class="span2"> </div>
		</div>
		<div class="row cl" >
        	...
        	<div class="formControls span6">
        			<select id="Bmodule" name="Bmodule" data-placeholder="业务分类" class="select2"  nullmsg="业务分类">
