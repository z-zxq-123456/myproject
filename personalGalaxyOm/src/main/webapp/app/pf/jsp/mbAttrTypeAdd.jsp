...
<head>
<title>参数类型添加</title>
<script type="text/javascript" src="${ContextPath}/app/pf/js/mbAttrTypeAdd.js"></script>
	...
	<form action="" method="post" class="form form-horizontal" id="form-attr-add">
		<div class="row cl">
			...
			<div class="formControls span6">
				<input type="text" class="input-text grid" value="" placeholder="attrKey" id="attrKey" name="attrKey" datatype="/^[A-Z\(_)]+$/" nullmsg="属性定义不能为空">
			</div>
			<div class="span2"> </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
        	...
        	<div class="formControls span6">
				<select class="select2" size="1" name="demo2" id ="busiCategory" datatype="*" name="busiCategory" multiple placeholder="请选择" nullmsg="业务分类不能为空">
				</select>
        </div>
        	<div class="span2"> </div>
        </div>
		...
		<div class="row cl">
			...
			<div class="formControls span6">
			    <select id="attrType" name="attrType" data-placeholder="参数类型" class="select2 " datatype="*1-40" nullmsg="参数类型不能为空">
