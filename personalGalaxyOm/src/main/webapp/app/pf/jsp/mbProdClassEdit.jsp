...
<html>
<head>
<script type="text/javascript" src="${ContextPath}/app/pf/js/mbProdClassEdit.js"></script>
<title>产品修改</title>
</head>
<body>
<div class="padding-20">
	<form action="" method="post" class="form form-horizontal" id="form-prod-edit">
	<div class="row cl">
    			<label class="form-label span4"><span class="c-red">*</span>产品分类代码：</label>
    			<div class="formControls span6">
    				<input type="text" class="input-text grid" value="" placeholder="prodClass" id="prodClass" name="prodClass" datatype="*1-40" nullmsg="产品分类代码不能为空" disabled="true">
    			</div>
    			<div class="span2"> </div>
    		</div>
    		<div class="row cl">
