    ...
    <%@ include file="/form.jsp" %>
        <html>
            <head>
                    ...
                    <script type="text/javascript" src="${ContextPath}/app/pf/js/mbProdDefine.js"></script>
            ...
            <div class="step-body span-offset-1 span10 span-setoff-1 mt-20" id="myStep" >
                                  ...
                                  <div class="tabbable-custom " style="border:solid 3px #e5e5e5">
                                      ...
                                      <div class="tab-content">
                                          <div id="tab_1_1" class="tab-pane active">
                                            ...
                                            <iframe id="index" src="" style="width:100%;height:500px;border:solid 3px #e5e5e5;"></iframe>
                                       </div>
                                          <div id="tab_1_2" class="tab-pane">
                                              <div class="tabCon">
                                                  <a id="IRL_FEE_MAPPING" class="button-select">费用启用规则定义</a>
                                               </div>
                                               <iframe id="index1" src="" style="width:100%;height:500px;border:solid 3px #e5e5e5;"></iframe>
                                          </div>
                                      </div>
                                  </div>
                                </div>
                        ...
                        <div class="step-list" style="margin-top:30px;">
                                <div class="text-c"><!--5-->
                                   ...
                                   <div class="tabbable-custom mt-20" style="border:solid 3px #e5e5e5">
                                         <ul class="nav nav-tabs ">
                                          ...
                                          <div class="tab-content">
                                           ...
                                           <div>
                                           <iframe id="index2" src="" style="width:100%;height:500px;margin-top:20px;border:solid 3px #e5e5e5"></iframe>
                                           </div>
                                           </div>
                                       </div>
                                   </div><!--5-->
