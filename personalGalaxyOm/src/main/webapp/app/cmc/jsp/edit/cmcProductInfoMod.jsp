...
<html>
<head>
<title>参数表CMC_PRODUCT_INFO修改</title>
<script type="text/javascript" src="${ContextPath}/app/cmc/js/edit/cmcProductInfoMod.js"></script>
</head>
<body>
<div class="pd-20">
	<form class="form form-horizontal" method="post" id="cmcProductInfoMod">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <select id="cardCrdbflg" name="cardCrdbflg"  class="select2" datatype="/^\d{1}$/" tipmsg="格式错误!" nullmsg="请选择！" >
                    <option value="" selected="selected">请选择</option>
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="atmErrNum" id="atmErrNum" name="atmErrNum" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!">
            </div>
            <div class="span2"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="totalErrNum" id="totalErrNum" name="totalErrNum" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!">
            </div>
            <div class="span2"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="cvnTotErrNum" id="cvnTotErrNum" name="cvnTotErrNum" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!">
            </div>
            <div class="span2"> </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="cvn2TotErrNum" id="cvn2TotErrNum" name="cvn2TotErrNum" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!">
            </div>
            <div class="span2"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="lastTotErrNum" id="lastTotErrNum" name="lastTotErrNum" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!">
            </div>
            <div class="span2"> </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" value="" placeholder="maxHoldNo" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" id="maxHoldNo" name="maxHoldNo" tipmsg="格式错误!" >
            </div>
            <div class="span2"> </div>
        </div>
