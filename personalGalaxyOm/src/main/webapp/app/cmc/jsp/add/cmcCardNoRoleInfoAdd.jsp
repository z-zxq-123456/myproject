...
<script type="text/javascript" src="${ContextPath}/app/cmc/js/add/cmcCardNoRoleInfoAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="cmcCardNoRoleInfoAdd">
					...
					<div class="row cl">
						...
						<div class="formControls span6">
							<input type="text" class="input-text grid" value="" placeholder="fldnum2" datatype="*1-10" id="fldnum2" name="CMC_CARD_NO_ROLE_INFO"  nullmsg=" 请输入！" tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="vryBitLen" id="vryBitLen" name="CMC_CARD_NO_ROLE_INFO" datatype="*1-10" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
