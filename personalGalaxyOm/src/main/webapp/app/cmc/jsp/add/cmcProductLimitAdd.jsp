...
<script type="text/javascript" src="${ContextPath}/app/cmc/js/add/cmcProductLimitAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="cmcProductLimitAdd">
					...
					<div class="row cl">
						...
						<div class="formControls span6">
							<select id="channelType" name="CMC_PRODUCT_LIMIT" data-placeholder="限制渠道" class="select2"  tabindex="4" nullmsg=" 请输入！" datatype="*" tipmsg="格式错误!">
							</select>
						</div>
						<div class="span2"> </div>
					</div>
			<div class="row cl">
				...
				<div class="span2"> </div>
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="conLimitAmt" id="conLimitAmt" name="CMC_PRODUCT_LIMIT"
			...
			<div class="row cl">
				...
				<div class="formControls span6">
					<input type="text" class="input-text grid" value="" placeholder="tranInLimitAmt" id="tranInLimitAmt" name="CMC_PRODUCT_LIMIT"
						   datatype="/(^[1-9]([0-9]{1,15})?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/" nullmsg=" 请输入！"  tipmsg="格式错误!">
				</div>
				<div class="span2"> </div>
			</div>
			<div class="row cl">
				...
				<div class="formControls span6">
					<input type="text" class="input-text grid" value="" placeholder="tranOutLimitAmt" id="tranOutLimitAmt" name="CMC_PRODUCT_LIMIT"
						   datatype="/(^[1-9]([0-9]{1,15})?(\.[0-9]{1,2})?$)|(^(0){1}$)|(^[0-9]\.[0-9]([0-9])?$)/" nullmsg=" 请输入！"  tipmsg="格式错误!">
				</div>
				<div class="span2"> </div>
			</div>
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="conLimitTime" id="conLimitTime" name="CMC_PRODUCT_LIMIT" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="tranInLimitTime" id="tranInLimitTime" name="CMC_PRODUCT_LIMIT" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
					...
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="tranOutLimitTime" id="tranOutLimitTime" name="CMC_PRODUCT_LIMIT" datatype="/(^[0]{1}$)|(^[1-9]{1}[0-9]{0,4}$)/" nullmsg=" 请输入！"  tipmsg="格式错误!" >
						</div>
						<div class="span2"> </div>
					</div>
			<div class="row">
