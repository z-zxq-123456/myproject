...
<script type="text/javascript" src="${ContextPath}/app/cmc/js/add/cmcCardNoParamAdd.js"></script>
</head>
<body>
	<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="cmcCardNoParamAdd">
					<div class="row cl">
						...
						<div class="formControls span6">
											<input type="text" class="input-text grid" value="" placeholder="productRuleNo" id="productRuleNo" name="CMC_CARD_NO_PARAM" datatype="*1-4" nullmsg=" 请输入！"  tipmsg="格式错误!">
						</div>
						<div class="span2"> </div>
					</div>
					<div class="row cl">
