...
<head>
<title>用户添加</title>
<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/serv/appSerinfoEdit.js"></script>
</head>
<body>
<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="form-appSerinfo-edit">
        	    <div class="row">
                ...
                <div class="row">
                       ...
                       <div class="formControls span6">
                           <input type="text" class="input-text grid" id="appSerClsnm" placeholder="请输入3-20位字符"  name="appSerClsnm" datatype="*3-20" nullmsg="请输入！" tipmsg="格式错误!">
                       </div>
                       <div class="span2"></div>
                </div>
                <div class="row">
