...
<head>
<title>用户添加</title>
<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/serv/routerColEdit.js"></script>
</head>
<body>
<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="form-routerCol-edit">
        	    <div class="row">
                    <label class="form-label span4"><span class="c-red">*</span>字段中文名：</label>
                    <div class="formControls span6">
                        <input type="text" class="input-text grid" id="routerColCn" placeholder="请输入1-20位字符"  name="routerColCn" datatype="*1-100" nullmsg="请输入！" tipmsg="格式错误!">
                    </div>
                    <div class="span2"></div>
                </div>
                <div class="row">
