...
<head>
    <title>用户添加</title>
    <script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/serv/servRuleAdd.js"></script>
</head>
<body>
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-servRule-add">
        <div class="row">
            <label class="form-label span4"><span class="c-red">*</span>路由规则类型：</label>
            <div class="formControls span6">
                <select name="servRuleTypeName" id="servRuleTypeName" size="1" class="select2" style="margin-top:5px">
                </select>
            </div>
            <div class="span2"></div>
        </div>
        ...
        <div class="row" id="posDiv">
            ...
            <div class="formControls span6">
                <input type="text" class="input-text grid" id="routerArgsPos" placeholder="请输入1-20位数字"
                       name="routerArgsPos" datatype="n1-20" nullmsg="请输入！" tipmsg="格式错误!">
            </div>
            <div class="span2"></div>
        </div>
        ...
        <div class="row" id="selfDiv">
            ...
            <div class="formControls span6">
                <textarea name="" cols="" rows="" style="width:265px" id="servRuleSelf" name="servRuleSelf"
                          dragonfly="true" datatype="*0-50" placeholder="请输入不多于50位字符！" nullmsg="请输入！" tipmsg="格式错误!"
