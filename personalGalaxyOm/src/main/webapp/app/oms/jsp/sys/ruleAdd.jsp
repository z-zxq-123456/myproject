...
<head>
    <title>参数信息增加</title>
     <script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/sys/ruleAdd.js"></script>
</head>
<body>
<div class="pd-20">
    <form action="" method="post" class="form form-horizontal" id="form-parameter-add" name="fileForm">
        ...
        <div class="row">
            ...
            <div class="formControls span6">
                 <textarea cols="" rows=""  id="ruleDesc" name="ruleDesc" style="width:200px" placeholder="请输入0-100位字符"
            ...
            <div class="span2" style="position: absolute; right: 50px;"> </div>
        </div>
