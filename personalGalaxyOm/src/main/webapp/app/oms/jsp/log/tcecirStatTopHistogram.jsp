...
<html>
	<head>
		...
		<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/log/tcecirStatTopHistogram.js"></script>
	</head>
	<body>
	<div class="mb-10">
          			 <nav class="breadcrumb"><i class="iconfont">&#xe61d;</i>系统首页<span>&gt;</span><a href="#">管理视图</a><span >&gt;</span><span >调用环TOP统计图</span><a  href="javascript:location.replace(location.href);" title="刷新" ><i class="iconfont">&#xe61e;</i></a></nav>
    		</div>
