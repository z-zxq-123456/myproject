...
<html>
	<head>
		<title>应用实例停止</title>
		<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/app/stopAppInstant.js"></script>
	</head>
	 ...
	 <div id="toolbar" style="padding:5px;height:auto">	
	   <div>		
		...
		<div style="margin-bottom:5px; padding-left:50px;">
			 <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="stopApp()">停止</a> 	
