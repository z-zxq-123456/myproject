...
<head>
<title>用户添加</title>
<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/middleware/dbEdit.js"></script>
</head>
<body>
<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="form-dbInfo-edit">
        	    <div class="row">
        		...
        		<div class="row">
        			...
        			<div class="formControls span6">
        				<input type="text" class="input-text grid" id="dbintName" placeholder="请输入2-20位字符"  name="dbintName" datatype="s2-20" nullmsg="请输入！" tipmsg="格式错误!">
        			</div>
        			<div class="span2"></div>
        		</div>
        	    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="formControls span6">
                        <input type="text" class="input-text grid" id="dbintServiceName" placeholder="请输入1-5位数字"  name="dbintServiceName" datatype="s1-50" nullmsg="请输入！" tipmsg="格式错误!">
                    </div>
                    <div class="span2"></div>
                </div>
                <div class="row">
                    ...
                    <div class="formControls span6">
                        <input type="text" class="input-text grid" id="dbintNodeNum" placeholder="请输入1-10位数字"  name="dbintNodeNum" datatype="*1-10" nullmsg="请输入！" tipmsg="格式错误!">
                    </div>
                    <div class="span2"></div>
                </div>
                <div class="row">
