...
<html>
<head>
<title>Redis主键增加</title>
	 <script type="text/javascript" src="${ContextPath}/app/oms/js/middleware/redisKeyAdd.js"></script>
</head>
<body>
<div class="pd-20">
	<form action="" method="post" class="form form-horizontal" id="form-redisKey-add">
        <div class="row cl">
            <label class="form-label span4"><span class="c-red">*</span>Redis服务器的名称：</label>
            <div class="formControls span6">
                <input type="text" class="input-text grid" name="masterName" id="masterName" placeholder="不能为空！" nullmsg="请输入！" tipmsg="格式错误!" disabled=true>
            </div>
            <div class="span2"> </div>
        </div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls span6">
				<input type="text" class="input-text grid"  name="seqKey" id="seqKey" datatype="*1-100" placeholder="请输入1-100位字符！" nullmsg="请输入！" tipmsg="格式错误!">
			</div>
			<div class="span2"> </div>
		</div>
		<div class="row cl">
