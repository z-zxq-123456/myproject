...
<head>
<title>用户添加</title>
<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/middleware/midwareRedisEdit.js"></script>
</head>
<body>
<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="form-redisInfo-edit">
        	    <div class="row">
                    <label class="form-label span4"><span class="c-red">*</span>集群名称：</label>
                    <div class="formControls span6">
                        <input type="text" class="input-text grid" id="queryMidwareId" placeholder="请输入3-20位字符"  name="queryMidwareId" datatype="*3-20" nullmsg="请输入！" tipmsg="格式错误!">
                    </div>
                    <div class="span2"></div>
                </div>
        		<div class="row">
               ...
               <div class="row">
                   ...
                   <div >
                       <input type="text" style = "width:318px" class="input-text grid" id="redisintMemory" placeholder="请输入1-2位数字"  name="redisintMemory" datatype="n1-2" nullmsg="请输入！" tipmsg="格式错误!"><font  color ="red">&nbspG</font>
                   </div>
                   <div class="span2"></div>
               </div>
                <div class="row">
