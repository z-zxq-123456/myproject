...
<head>
<title>用户修改</title>
<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/middleware/zkEdit.js"></script>
</head>
<body>
<div class="pd-20">
		<form action="" method="post" class="form form-horizontal" id="form-zkInfo-edit">
        	    <div class="row">
                    <label class="form-label span4"><span class="c-red">*</span>集群名称：</label>
                    <div class="formControls span6">
                        <input type="text" class="input-text grid" id="queryMidwareId" placeholder="请输入3-20位字符"  name="queryMidwareId" datatype="*1-20" nullmsg="请输入！" tipmsg="格式错误!"  disabled>
                    </div>
                    <div class="span2"></div>
                </div>
        		<div class="row">
        		...
        		<div class="row">
        			...
        			<div class="formControls span6">
        				<input type="text" class="input-text grid" id="zkintName" placeholder="请输入3-20位字符"  name="zkintName" datatype="s3-20" nullmsg="请输入！" tipmsg="格式错误!">
        			</div>
        			<div class="span2"></div>
        		</div>
        	    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="formControls span6">
                        <input type="text" class="input-text grid" id="zkintNodeNum" placeholder="请输入1-5位数字"  name="zkintNodeNum" datatype="n1-5" nullmsg="请输入！" tipmsg="格式错误!">
                    </div>
                    <div class="span2"></div>
                </div>
                <div class="row">
