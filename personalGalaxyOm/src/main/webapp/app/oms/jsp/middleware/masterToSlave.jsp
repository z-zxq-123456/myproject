...
<html>
<head>
    <title>Redis主备切换</title>
    <script type="text/javascript" src="${ContextPath}/app/oms/js/middleware/masterToSlave.js"></script>
</head>
<body>
<div class="mb-10">
    <nav class="breadcrumb"><i class="iconfont">&#xe61d;</i>系统首页</a><span>&gt;</span>中间件管理</a><span>&gt;</span>Redis</a><span>&gt;</span><span>Redis主备切换</span><a
 ...
 <form action="" method="post" class="form form-horizontal" id="selectForm" name="selectForm">
                <div class="row">
                         ...
                         <div class="span2"></div>
                         <label class="form-label span2"><span class="c-red">*</span>节点：</label>
                                                  <div class="span3">
                                                       <select name="queryRedisintNodeNum" id="queryRedisintNodeNum" size="1" class="select2" style="margin-top:5px">
                                                       </select>
                                                  </div>
                </div>
                </form>
