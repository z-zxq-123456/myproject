...
<html>
	<head>
		<title>应用部署视图</title>
		<script type="text/javascript" charset="UTF-8"	src="${ContextPath}/app/oms/js/leaderview/appDeployViewManager.js"></script>
	</head>
	<body>
       <div class="mb-10">
      			 <nav class="breadcrumb"><i class="iconfont">&#xe61d;</i>系统首页<span>&gt;</span><a href="#">操作流水</a><span >&gt;</span><span >应用监控流水</span>
      			 <span >&gt;</span><span >应用部署流水</span>
	  ...
	  <div class="mr-20 ml-20 mt-10">
     				<table id="deployViewList" class="table table-border table-bordered table-hover table-bg table-sort">
     					<thead>
     					<tr>
     						<th>应用部署日期</th>
     						<th>应用名称</th>
