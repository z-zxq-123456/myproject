...
public class EncodingDetectUtils {
     ...
     * @return 文件的编码
     */
    public static String fileEncode(byte[] file) {
        BytesEncodingDetect s = new BytesEncodingDetect();
        String fileCode = BytesEncodingDetect.javaname[s.detectEncoding(file)];
        return fileCode;
    }
     ...
     * @return 文件的编码
     */
    public static String fileEncode(URL fileUrl) {
        BytesEncodingDetect s = new BytesEncodingDetect();
        String fileCode = BytesEncodingDetect.javaname[s.detectEncoding(fileUrl)];
        return fileCode;
    }
}
