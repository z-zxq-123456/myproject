...
public class ProtocolConfig extends AbstractConfig {
    ...
    public static void destroyRemain(){
		...
		prop.setProperty("com.alibaba.dubbo.remoting.transport.AbstractClient", "reconnectExecutorService");
		prop.setProperty("com.alibaba.dubbo.remoting.exchange.support.header.HeaderExchangeClient", "scheduled");
		prop.setProperty("com.alibaba.dubbo.remoting.transport.Dispather", "SHARED_EXECUTOR");
