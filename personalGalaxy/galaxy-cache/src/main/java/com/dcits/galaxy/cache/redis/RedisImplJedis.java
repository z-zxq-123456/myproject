...
public class RedisImplJedis implements RedisCommands {

	private Jedis jedis = null;

	private boolean close = false;
	
	public RedisImplJedis(Jedis jedis) {
		this.jedis = jedis;
	}
...
//		List<byte[]> result = getJedis().blpop(timeout, keys);
//		return result;
//	}
//
//	@Override
//	public List<byte[]> brpop(int timeout, byte[]... keys) {
//		List<byte[]> result = getJedis().brpop(timeout, keys);
//		return result;
//	}
