...
public class TestKeyIndexParaCache extends TestBase implements ICacheStore{
	public  void testGetList() {		
		TabTrail trail = new TabTrail();		
		System.out.println(ParaTabCacheProxy.getListBean("tabTrail","prdId","1",trail).size());//出口BEAN  LIST	
		
		System.out.println(ParaTabCacheProxy.getListMap("tabTrail","prdType","1"));//出口MAP list
